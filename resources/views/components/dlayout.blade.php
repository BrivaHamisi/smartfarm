        ...
        <div class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg flex flex-col transform transition-transform duration-300 ease-in-out lg:static lg:transform-none" :class="{ '-translate-x-full': !open, 'translate-x-0': open }">
            ...
            <nav class="mt-4 flex-1 flex flex-col overflow-y-auto">
                <div class="px-2 space-y-1 flex-1">
                    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('dashboard') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('cattle.milk-records.index') }}" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('cattle.milk-records.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('poultry.index') }}" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('poultry.index') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('calves.index') }}" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('calves.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('finances.index') }}" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('finances.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('workers.index') }}" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('workers.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                ...
                <div class="px-2 space-y-1 border-t border-gray-200 pt-4">
                    <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('profile.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 text-gray-600 hover:bg-emerald-50 hover:text-emerald-700">
