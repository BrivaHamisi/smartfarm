    ...
    <div class="flex h-screen bg-gray-100" x-data="{ open: false, cattleOpen: false }" x-init="() => { if (window.innerWidth < 1024) open = false }">
        ...
        <div class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg flex flex-col transform transition-transform duration-300 ease-in-out lg:static lg:transform-none" :class="{ '-translate-x-full': !open, 'translate-x-0': open }">
            ...
            <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200">
                ...
                <button @click="open = false" class="lg:hidden p-2 text-gray-600 hover:text-gray-900">
            ...
            <nav class="mt-4 flex-1 flex flex-col overflow-y-auto">
                <div class="px-2 space-y-1 flex-1">
                    <a href="{{ route('dashboard') }}" @click="open = false" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('dashboard') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('cattle.index') }}" @click="open = false" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('cattle.index') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('cattle.milk-records.index') }}" @click="open = false" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('cattle.milk-records.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('poultry.index') }}" @click="open = false" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('poultry.index') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('calves.index') }}" @click="open = false" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('calves.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('finances.index') }}" @click="open = false" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('finances.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <a href="{{ route('workers.index') }}" @click="open = false" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('workers.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                ...
                <div class="px-2 space-y-1 border-t border-gray-200 pt-4">
                    <a href="{{ route('profile.edit') }}" @click="open = false" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('profile.*') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a href="{{ route('logout') }}" @click="open = false" onclick="event.preventDefault(); this.closest('form').submit();" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 text-gray-600 hover:bg-emerald-50 hover:text-emerald-700">
