        ...
        <div class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg flex flex-col transform transition-transform duration-300 ease-in-out lg:static lg:transform-none" :class="{ '-translate-x-full': !open, 'translate-x-0': open }">
            ...
            <nav class="mt-4 flex-1 flex flex-col overflow-y-auto">
                <div class="px-2 space-y-1 flex-1">
                    <a href="{{ url('/dashboard') }}" @click="open = false; console.log('Dashboard clicked, open:', open)" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->is('dashboard') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                        <svg class="w-5 h-5 {{ request()->is('dashboard') ? 'text-emerald-500' : 'text-gray-500' }} transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ url('/dashboard/cattle') }}" @click="open = false; console.log('Cattle clicked, open:', open)" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->is('dashboard/cattle') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                        <svg class="w-5 h-5 {{ request()->is('dashboard/cattle') ? 'text-emerald-500' : 'text-gray-500' }} transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path>
                        </svg>
                        <span class="ml-3 font-medium">Cattle</span>
                    </a>
                    <a href="{{ url('/dashboard/milk-records') }}" @click="open = false; console.log('Milk Records clicked, open:', open)" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->is('dashboard/milk-records') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                        <svg class="w-5 h-5 {{ request()->is('dashboard/milk-records') ? 'text-emerald-500' : 'text-gray-500' }} transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span class="ml-3 font-medium">Milk Records</span>
                    </a>
                    <a href="{{ url('/dashboard/poultry') }}" @click="open = false; console.log('Poultry clicked, open:', open)" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->is('dashboard/poultry') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                        <svg class="w-5 h-5 {{ request()->is('dashboard/poultry') ? 'text-emerald-500' : 'text-gray-500' }} transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path>
                        </svg>
                        <span class="ml-3 font-medium">Poultry</span>
                    </a>
                    <a href="{{ url('/dashboard/calves') }}" @click="open = false; console.log('Calves clicked, open:', open)" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->is('dashboard/calves') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                        <svg class="w-5 h-5 {{ request()->is('dashboard/calves') ? 'text-emerald-500' : 'text-gray-500' }} transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ url('/dashboard/finances') }}" @click="open = false; console.log('Finances clicked, open:', open)" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->is('dashboard/finances') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                        <svg class="w-5 h-5 {{ request()->is('dashboard/finances') ? 'text-emerald-500' : 'text-gray-500' }} transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                        <span class="ml-3 font-medium">Finances</span>
                    </a>
                    <a href="{{ url('/dashboard/workers') }}" @click="open = false; console.log('Workers clicked, open:', open)" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->is('dashboard/workers') ? 'text-emerald-700 bg-emerald-50' : 'text-gray-600 hover:bg-emerald-50 hover:text-emerald-700' }}">
                        <svg class="w-5 h-5 {{ request()->is('dashboard/workers') ? 'text-emerald-500' : 'text-gray-500' }} transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <h2 class="text-lg font-semibold text-gray-800">
                            @if (request()->is('dashboard'))
                                Dashboard
                            @elseif (request()->is('dashboard/cattle'))
                                Cattle
                            @elseif (request()->is('dashboard/milk-records'))
                                Milk Records
                            @elseif (request()->is('dashboard/poultry'))
                                Poultry
                            @elseif (request()->is('dashboard/calves'))
                                Calves
                            @elseif (request()->is('dashboard/finances'))
                                Finances
                            @elseif (request()->is('dashboard/workers'))
                                Workers
