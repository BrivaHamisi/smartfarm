                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <select name="gender" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500" required>
                            ...
                            <option value="doe"  @selected(old('gender') === 'doe')>Doe (Female)</option>
                            <option value="buck" @selected(old('gender') === 'buck')>Buck (Male)</option>
                        </select>
                        @error('gender')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                    </div>
                </div>
                <div class="mt-6 flex gap-3">
                    <button type="submit" class="px-5 py-2 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 font-medium">Save Rabbit</button>
