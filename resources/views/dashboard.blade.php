                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex items-center space-x-2 text-emerald-600">
                                <span
                                    class="text-sm font-medium">{{ $morningChange >= 0 ? '+' : '' }}{{ $morningChange }}%</span>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="{{ $morningChange >= 0 ? 'M5 10l7-7m0 0l7 7m-7-7v18' : 'M19 14l-7 7m0 0l-7-7m7 7V3' }}">
                                    </path>
                                </svg>
                            </div>
                        </div>
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex items-center space-x-2 text-emerald-600">
                                <span
                                    class="text-sm font-medium">{{ $afternoonChange >= 0 ? '+' : '' }}{{ $afternoonChange }}%</span>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="{{ $afternoonChange >= 0 ? 'M5 10l7-7m0 0l7 7m-7-7v18' : 'M19 14l-7 7m0 0l-7-7m7 7V3' }}">
                                    </path>
                                </svg>
                            </div>
                        </div>
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            <div class="flex items-center space-x-2 text-emerald-600">
                                <span
                                    class="text-sm font-medium">{{ $eveningChange >= 0 ? '+' : '' }}{{ $eveningChange }}%</span>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="{{ $eveningChange >= 0 ? 'M5 10l7-7m0 0l7 7m-7-7v18' : 'M19 14l-7 7m0 0l-7-7m7 7V3' }}">
                                    </path>
                                </svg>
                            </div>
                        </div>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        @foreach ($tasks as $task)
                            <div
                                class="flex items-center space-x-4 p-4 {{ $task->urgent ? 'bg-red-50' : 'bg-amber-50' }} rounded-lg">
                                <div class="flex-shrink-0">
                                    <div
                                        class="h-10 w-10 rounded-lg {{ $task->urgent ? 'bg-red-100' : 'bg-amber-100' }} flex items-center justify-center">
                                        <svg class="h-5 w-5 {{ $task->urgent ? 'text-red-600' : 'text-amber-600' }}"
                                ...
                                <button
                                    class="px-3 py-1 {{ $task->urgent ? 'bg-red-100 text-red-600' : 'bg-amber-100 text-amber-600' }} rounded-lg text-sm font-medium">
                                ...
                                @foreach ($recentRecords as $record)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $record['status'] == 'Recorded' ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800' }}">
                                                {{ $record['status'] }}
                                            </span>
                                        </td>
                                    </tr>
